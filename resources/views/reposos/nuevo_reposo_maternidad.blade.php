    ...
    <div class="col-sm-12 col-xl-12">
        ...
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <form method="POST" action="{{ route('create.reposo.maternidad') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="es_prenatal" class="form-label">¿Es Pre-Natal?:</label>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="es_prenatal" id="inlineRadio1" value="1" checked>
                        <label class="form-check-label" for="inlineRadio1">Sí</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="es_prenatal" id="inlineRadio2" value="0">
                        <label class="form-check-label" for="inlineRadio2">No</label>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="es_postnatal" class="form-label">¿Es Post-Natal?:</label>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="es_postnatal" id="inlineRadio1" value="1">
                        <label class="form-check-label" for="inlineRadio1">Sí</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="es_postnatal" id="inlineRadio2" value="0" checked>
                        <label class="form-check-label" for="inlineRadio2">No</label>
                    </div>
                </div>
